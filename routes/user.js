...
const { getUserDataFirst, logoutUser, editUser, changePassword } = require("../controllers/userController");
const { getProducts, getProduct } = require("../controllers/user/productController");
